...
int main(int ac, char** av)
{
	...
	auto newGraph = matrixToGraph(matr, {Direction::Bottom, Direction::Right, Direction::Top, Direction::Left});
	
	newGraph.connectFromToNodes("begin", "0,0", matr(0, 0));
	newGraph.connectFromToNodes(std::to_string(matr.rows() - 1) + "," + std::to_string(matr.cols() - 1), "end", 0);
